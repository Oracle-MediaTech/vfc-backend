...
class AttendanceRoute implements Routes {
   ...
   private initializeRoutes() {
      ...
      this.router.get(
         `${this.path}/analytics/summary`,
         authenticate,
         this.attendanceController.getAttendanceSummary,
      );

      this.router.get(
         `${this.path}/analytics/top-members`,
         authenticate,
         this.attendanceController.getTopMembers,
      );

      this.router.get(
         `${this.path}/analytics/member-history/:userId`,
         authenticate,
      ...
      this.router.get(
         `${this.path}/analytics/trend`,
         authenticate,
         this.attendanceController.getAttendanceTrend,
      );

      this.router.get(
         `${this.path}/analytics/rate`,
         authenticate,
      ...
      this.router.put(
         `${this.path}/bulk-update/:id`,
         authenticate,
         this.attendanceController.bulkSessionUpdate,
      );
